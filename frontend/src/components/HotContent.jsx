        ...
        <div className="w-full pb-10 bg-[#f9f9f9] py-[50px] max-sm:py-[150px]">
            ...
            md:gap-x-8 sm:gap-y-8 ss:gap-y-8 px-4 sm:pt-20 md:mt-0 ss:pt-20 text-black">
                    ...
                    <div className="col-span-2 bg-white p-4 rounded-xl drop-shadow-md">
                        <img src={`${data.coverImg.data.url}`} alt="" className='h-76 w-full object-cover' />
                        <h1 className="font-bold text-2xl my-1 pt-5">{data.title}</h1>
                    ...
                    <div className="bg-white w-full h-max drop-shadow-md rounded-xl py-5 px-4 max-sm:col-span-2 max-sm:mt-8">
                        <img src={`${data.authorImg.data.url}`} alt="" className='p-2 w-40 h-40 rounded-full mx-auto' />
                        <Link to="/author">
                            <h1 className="font-bold text-2xl text-center text-gray-900 pt-3 mb-4">{data.authorName}</h1>
                        </Link>
